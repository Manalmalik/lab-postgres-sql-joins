...
FROM publishers LEFT JOIN books ON publishers.id = books.publisher_id;
```
...
```sql
SELECT books.* , publishers.*
FROM publishers RIGHT JOIN books ON publishers.id = books.publisher_id;
```
...
```sql
SELECT books.* , publishers.*, authors.*
